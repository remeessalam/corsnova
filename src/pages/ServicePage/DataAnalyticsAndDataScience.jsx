...
import img1 from "../../assets/images/services/data-analytics1.jpg";
import img2 from "../../assets/images/services/data-analytics2.jpg";
import { Link } from "react-router-dom";
import { ArrowRightCircle } from "lucide-react";
import { allServices } from "../../constant";

const DataAnalyticsAndDataScience = () => {
  const next = allServices[8];
  const service = allServices[7];
  return (
    <div className="flex flex-col gap-10 text-black">
      <img
        ...
        alt="Data Analytics and Data Science"
      />
      <div className="flex flex-col gap-4">
        ...
        <h2 data-aos="fade-up" className="text-2xl font-semibold mt-5">
          Understanding Our Approach to Data Analytics and Data Science
        </h2>
        <p data-aos="fade-up" className="description">
...
export default DataAnalyticsAndDataScience;
