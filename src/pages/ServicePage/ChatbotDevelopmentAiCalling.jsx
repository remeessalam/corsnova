...
import img1 from "../../assets/images/services/chatbot-development1.jpg";
import img2 from "../../assets/images/services/chatbot-development2.jpg";
import { Link } from "react-router-dom";
import { ArrowRightCircle } from "lucide-react";
import { allServices } from "../../constant";

const ChatbotDevelopmentAiCalling = () => {
  const next = allServices[5];
  const service = allServices[4];
  return (
    <div className="flex flex-col gap-10 text-black">
      <img
        ...
        alt="Chatbot Development / AI Calling"
      />
      <div className="flex flex-col gap-4">
        <h2 data-aos="fade-up" className="heading-2 !text-black">
          Chatbot Development / AI Calling
        </h2>
        <p data-aos="fade-up" className="description">
          {service.description}
        </p>
        <h2 data-aos="fade-up" className="text-2xl font-semibold mt-5">
          Understanding Our Approach to Chatbot Development / AI Calling
        </h2>
        <p data-aos="fade-up" className="description">
...
export default ChatbotDevelopmentAiCalling;
