...
import img1 from "../../assets/images/services/cloud-migration1.jpg";
import img2 from "../../assets/images/services/cloud-migration2.jpg";
    ...
    <div className="flex flex-col gap-10 text-black">
      ...
      <div className="flex flex-col gap-4">
        ...
        <h2 data-aos="fade-up" className="text-2xl font-semibold mt-5">
          Understanding Our Approach to Cloud Migration Services
        </h2>
        <p data-aos="fade-up" className="description">
