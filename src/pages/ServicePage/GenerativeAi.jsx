...
import img1 from "../../assets/images/services/generative-ai-applications1.jpg";
import img2 from "../../assets/images/services/generative-ai-applications2.jpg";
    ...
    <div className="flex flex-col gap-10 text-black">
      ...
      <div className="flex flex-col gap-4">
        ...
        <h2 data-aos="fade-up" className="text-2xl font-semibold mt-5">
          Understanding Our Approach to Generative AI Applications
        </h2>
        <p data-aos="fade-up" className="description">
