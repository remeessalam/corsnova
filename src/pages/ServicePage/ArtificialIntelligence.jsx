...
import img1 from "../../assets/images/services/ai-development1.jpg";
import img2 from "../../assets/images/services/ai-development2.jpg";
  ...
  return (
    <div className="flex flex-col gap-10 text-black">
      <img
        ...
        alt="Artificial Intelligence Development and Integration"
      />
      <div className="flex flex-col gap-4">
        ...
        <h2 data-aos="fade-up" className="text-2xl font-semibold mt-5">
          Understanding Our Approach to Artificial Intelligence Development and
          Integration
        </h2>
        <p data-aos="fade-up" className="description">
